    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Research Data Platform (Storage \& API Layer)}
          ...
          \resumeItemListStart
            \workItem{}
              {Designed and built a centralized research data platform from the ground up, now adopted by \textbf{all systematic desks}}
            \workItem{}
        ...
        \resumeItem{Market Data Infrastructure (Tick Pipeline)}
          ...
          \resumeItemListStart
            \workItem{}
              {Designed and built a tick data ingestion pipeline ingesting data from multiple market venues in real time, processing \textbf{30B+ market events/day} across \textbf{27M+ unique instruments}}
            \workItem{}
 ...
 \resumeSubHeadingListStart
    \resumeCoding {Coding}
      \resumeItemListStart
        ...
        {Created and open-sourced a library that allows runtime validation for attrs dataclasses in Python.(50,000 monthly downloads)}
